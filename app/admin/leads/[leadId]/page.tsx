    ...
    <div>
      <div className="dashboard-topbar">
        <div>
          ...
          <p className="mini-meta">Qualify the consultation request and move the client toward proposal, contract, and deposit.</p>
        </div>
        <div className="topbar-actions">
          {!isConverted && !isArchived ? (
            <>
              ...
              <ButtonLink href={`/admin/leads/${leadId}?action=convert`}>Convert to Client</ButtonLink>
      ...
      <div className="dashboard-grid">
        <section className="panel span-2">
          ...
          <dl className="resource-details">
            <div><dt>Status</dt><dd><span className="status">{statusLabels[lead.status] ?? lead.status}</span></dd></div>
        ...
        <section className="panel">
          ...
          <ul className="list">
            ...
            <li>
              ...
              <span className="status">{consultation ? statusLabels[consultation.status] ?? consultation.status : "Not scheduled"}</span>
            </li>
