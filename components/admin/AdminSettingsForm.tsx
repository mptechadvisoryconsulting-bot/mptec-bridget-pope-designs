  ...
  return (
    <div className="dashboard-grid">
      <form className="panel form-grid span-2" onSubmit={saveSettings}>
        ...
        <p className="mini-meta wide">These settings control who receives inquiry, invoice, message, and payment notifications, and how outgoing email identifies the business.</p>
        ...
        <Field label="Invoice From Display Name">
          <Input
            disabled={!canManageOwnerSettings}
        ...
        <Field label="Invoice Reply-To Email">
          <Input
            disabled={!canManageOwnerSettings}
